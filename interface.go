...
// which the caller must guard against. For hard-fail semantics
// (test aborts on mismatch, return value safe to use unconditionally)
// use [github.com/lczyk/assert/require.Type] instead.
